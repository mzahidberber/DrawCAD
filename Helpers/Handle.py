...
class Handle(QGraphicsObject):
    ...
    @type.setter
    def type(self,type:HandleTypes):self.__type=type

    @property
    def centerPoint(self):return self.__centerPoint
    @centerPoint.setter
    def centerPoint(self,point:QPointF):self.__centerPoint=point

    @property
    def pen(self):return self.__pen
    @pen.setter
    def pen(self,pen:QPen):self.__pen=pen
    ...
    def boundingRect(self):return self.__square
