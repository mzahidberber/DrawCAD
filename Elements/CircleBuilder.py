...
class CircleBuilder(ElementBuilder):
    ...
    def setPointsInformation(self):
        ...
        self.__p2=QPointF(
            self.element.points[2].pointX,
            self.element.points[2].pointY)
        self.__p3=QPointF(
            self.element.points[3].pointX,
            self.element.points[3].pointY)
        self.__p4=QPointF(
            self.element.points[4].pointX,
            self.element.points[4].pointY)
