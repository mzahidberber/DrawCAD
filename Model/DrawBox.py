...
class DrawBox(BaseModel):
    ...
    @property
    def drawBoxId(self):return self.__drawBoxId

    @property
    def drawName(self):return self.__drawName
    ...
    def __init__(self,drawBoxInfo:dict) -> None:
        ...
        self.__layers=MappingModel.mapDictToClass(self.__drawBoxInfo[DBInfo.layers.value],Layer)
