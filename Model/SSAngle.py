...
class SSAngle(BaseModel):
    ...
    @property
    def ssAngleId(self) -> int:return self.__ssAngleId

    @property
    def ssAngleType(self) -> int:return self.__ssAngleType

    @property
    def ssAngleValue(self) -> int:return self.__ssAngleValue

    @property
    def ssAngleElementId(self) -> int:return self.__ssAngleElementId
