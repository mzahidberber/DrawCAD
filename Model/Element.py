...
class Element(BaseModel):
    ...
    @property
    def penId(self) -> int:return self.__penId
    @property
    def elementTypeId(self) -> int:return self.__elementTypeId
    @property
    def layerId(self) -> int :return self.__layerId
    @property
    def layer(self) -> int :return self.__layer
    @property
    def ssAngles(self) -> list[SSAngle] :return self.__ssAngles
    @property
    def radiuses(self) -> list[Radius] :return self.__radiuses
    @property
    def points(self) -> list[Point] :return self.__points
    ...
    def __init__(self,elementInfo:dict) -> None:
        ...
        self.__ssAngles=MappingModel.mapDictToClass(self.__elementInfo[EInfo.ssAngles.value],SSAngle)
        self.__radiuses=MappingModel.mapDictToClass(self.__elementInfo[EInfo.radiuses.value],Radius)
        self.__points=MappingModel.mapDictToClass(self.__elementInfo[EInfo.points.value],Point)
        
        if(self.__elementInfo[EInfo.layer.value]!=None):self.__layer=Layer(self.__elementInfo[EInfo.layer.value])
