...
class Color(BaseModel):
    ...
    @property
    def colorId(self):return self.__colorId

    @property
    def colorName(self):return self.__colorName

    @property
    def colorRed(self):return self.__colorRed
    @colorRed.setter
    def colorRed(self,red:int):self.__colorRed=red

    @property
    def colorBlue(self):return self.__colorBlue
    @colorBlue.setter
    def colorBlue(self,blue:int):self.__colorBlue=blue

    @property
    def colorGreen(self):return self.__colorGreen
    @colorGreen.setter
    def colorGreen(self,green:int):self.__colorGreen=green
