...
class Layer(BaseModel):
    ...
    @property
    def layerId(self):return self.__layerId

    @property
    def layerName(self):return self.__layerName

    @property
    def layerLock(self):return self.__layerLock

    @property
    def layerVisibility(self):return self.__layerVisibility

    @property
    def layerThickness(self):return self.__layerThickness

    @property
    def layerDrawBoxId(self):return self.__layerDrawBoxId

    @property
    def layerPenId(self):return self.__layerPenId

    @property
    def layerPen(self):return self.__layerPen
