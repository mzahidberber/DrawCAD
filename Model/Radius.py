...
class Radius(BaseModel):
    ...
    @property
    def radiusId(self) -> int:
        return self.__radiusId

    @property
    def radiusValue(self) -> float:
        return self.__radiusValue

    @radiusValue.setter
    def radiusValue(self, radius: float):
        self.__radiusValue = radius

    @property
    def radiusElementId(self) -> int:
        return self.__radiusElementId
