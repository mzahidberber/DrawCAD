...
class Ui_DrawView(object):
    def setupUi(self, DrawView):
        ...
        DrawView.addDockWidget(QtCore.Qt.DockWidgetArea(2), self.ElementsImformation)
    ...
    def retranslateUi(self, DrawView):
        ...
        self.ElementsImformation.setWindowTitle(_translate("DrawView", "Elements Imformation"))
...
"Middle Point Snap"))
        ...
        self.actionOrthoMode.setShortcut(_translate("DrawView", "F8"))
