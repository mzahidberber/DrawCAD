...
class Ui_EditLayer(object):
    def setupUi(self, EditLayer):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/Image/Images/addBtn.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/Image/Images/deleteBtn.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
